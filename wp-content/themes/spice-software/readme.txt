...
Spice Software WordPress Theme, Copyright (C) 2021-2022, spicethemes
Spice Software WordPress Theme is distributed under the terms of the GNU GPL
...
* Fixed colors & background setting issues.
* Updated mockup image in theme option's page.
...
@Version 1.0
* Fixed option page image issue.
* Removed unnecessary code.
* Updated some strings of the theme.

@Version 0.9
* Fixed minor style issues.
* Updated theme option's page.
...
https://pxhere.com/en/photo/1420053

* Images on /assets/images folder
Copyright (C) 2021-2022, spicethemes and available as [GPLv2](https://www.gnu.org/licenses/gpl-2.0.html)