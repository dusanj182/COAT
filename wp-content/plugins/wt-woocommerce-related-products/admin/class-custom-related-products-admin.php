...
class Custom_Related_Products_Admin {
    ...
    public function custom_related_products_crp_banner_width() {
        ...
        <fieldset class="crp-banner-width">
            <label>
                <input type="number" name="<?php echo $this->option_name . '_crp_banner_width'; ?>" id="<?php echo $this->option_name . '_crp_banner_width'; ?>" value="<?php echo esc_attr($crp_title); ?>" class="wt-crp-input"  min="50" max="100"><?php _e("%", 'wt-woocommerce-related-products' ); ?>
            </label>
      ...
      public function custom_related_products_crp_banner_product_width() {
        ...
        $crp_view_port = get_option($this->option_name . '_crp_banner_product_width', __('3', 'wt-woocommerce-related-products'));
        ?>
        <fieldset class="crp-banner-product-width">
            <label>
                <input type="number" name="<?php echo $this->option_name . '_crp_banner_product_width'; ?>" id="<?php echo $this->option_name . '_crp_banner_product_width'; ?>" value="<?php echo esc_attr($crp_view_port); ?>" class="wt-crp-input" min="3" max="6">
            </label>
    ...
    public function custom_related_products_crp_related_by() {
        ...
        $crp_related_by = (array) get_option($this->option_name . '_crp_related_by', array());
    ...
    public function custom_related_products_crp_order_by() {
        ...
        $crp_order_by = get_option($this->option_name . '_crp_order_by', '');
        ?>
    ...
    public function custom_related_products_crp_order() {
        ...
        $crp_order_by = get_option($this->option_name . '_crp_order', 'ASC');
        ?>
	...
	public function custom_related_products_crp_number() {
        ...
        $crp_number = get_option($this->option_name . '_crp_number', 3);
        ?>
        <fieldset class="crp-number">
            <label>
                <input type="number" name="<?php echo $this->option_name . '_crp_number'; ?>" id="<?php echo $this->option_name . '_crp_number'; ?>" value="<?php echo esc_attr(absint($crp_number)); ?>" class="wt-crp-input">
            </label>
	...
	public function custom_related_products_slider_cb() {
        ...
        $slider = get_option($this->option_name . '_slider');
        ?>
